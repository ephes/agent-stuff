"""Assemble a bounded review bundle from the working tree's git state.

Claude runs with tools disabled, so this bundle is the entire review surface.
Its contents are explicit and omissions are recorded, never silent.
"""
import os
import re
import subprocess
