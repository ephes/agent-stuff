...
Use once near the top of the markdown file:
...
## Flowchart Template (Marked 2 safe)

- Uses explicit theme variables.
- Uses intermediate nodes instead of edge labels.

```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#f3ecd4', 'secondaryColor': '#f3ecd4', 'tertiaryColor': '#f3ecd4', 'lineColor': '#111111', 'primaryBorderColor': '#111111'}, 'flowchart': {'htmlLabels': true}}}%%
flowchart LR
...
## Sequence Template (Marked 2 safe)
