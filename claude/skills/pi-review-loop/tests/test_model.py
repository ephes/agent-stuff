...
openai-codex  gpt-6-sol          372K     128K     yes       yes
...
class TestResolveModel(unittest.TestCase):
    def test_picks_approved_model(self):
        self.assertEqual(model.resolve_model(SAMPLE), "openai-codex/gpt-6-sol")

    def test_does_not_automatically_upgrade_to_newer_version(self):
        out = "openai-codex/gpt-6-sol\nopenai-codex/gpt-5.7-terra\n"
        self.assertEqual(model.resolve_model(out), "openai-codex/gpt-6-sol")
    ...
    def test_ensure_model_available_strips_thinking_suffix(self):
        ...
        with mock.patch("pi_review_loop.model.subprocess.run", return_value=completed) as run:
            self.assertEqual(
                model.ensure_model_available("openai-codex/gpt-6-sol:high")
                , "openai-codex/gpt-6-sol"
            )
        self.assertEqual(
